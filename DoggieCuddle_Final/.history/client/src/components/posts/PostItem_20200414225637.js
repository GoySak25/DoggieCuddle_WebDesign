    ...
    <div class="blog-card">
        <div class="blog-card__background">
          <div class="card__background--wrapper">
             <div class="card__background--main" style={{backgroundImage: {image}}}>
        ...
        <div className="blog-card__head">
          <span className="date__box">
            <span class="date__day"><Moment format='DD'>{date}</Moment></span>
            <span className="date__month"><Moment format='MM'>{date}</Moment></span>
          </span>
        </div>
