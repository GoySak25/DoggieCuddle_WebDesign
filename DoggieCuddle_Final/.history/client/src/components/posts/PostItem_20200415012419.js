...
<div class="blog-card spring-fever" style={{ backgroundImage: `url(${image})` }}>
    ...
    <div className="blog-card">
        ...
        <Fragment>
         ...
         <a href="#" class="icon-link mr-3"><i class="fa fa-pencil-square-o"></i> {name}</a>
          ...
          <p>{text}</p>
          {showActions &&  <a href="#" class="btn btn--with-icon"><i className="btn-icon fa fa-long-arrow-right"></i><Link to={`/posts/${_id}`}>READ MORE</Link></a>}
        </div> */}
