...
const useStyles = makeStyles((theme) => ({
  ...
  drawerPaper: {
    width: drawerWidth,
    backgroundImage: `url('http://www.autodatz.com/wp-content/uploads/2017/05/Old-Car-Wallpapers-Hd-36-with-Old-Car-Wallpapers-Hd.jpg')`
  },
    ...
    >
        ...
        <List>
            ...
            <ListItem button key={1}>
              ...
              <ListItemText > <Link to='/edit-profile' style={{color:"white", textDecoration:"none"}}>
         Edit Profile
      </Link> </ListItemText>
            </ListItem>
         ...
         Add Dog
            ...
            <ListItem button key={2}>
              <ListItemIcon ><DeleteForeverIcon style={{color:"white"}}/></ListItemIcon>
              <ListItemText> 
