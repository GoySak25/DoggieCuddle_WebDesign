...
import { Button, Row, Col, Modal , ModalDialog} from 'react-bootstrap';
...
const sameuser=()=>{
  ...
  <Modal.Header closeButton>
    <Modal.Title>Same user dog</Modal.Title>
  </Modal.Header>

  <Modal.Body>
    <p>The dog belongs to the loged-in user!!</p>
  </Modal.Body>
...
const ProfileItem = (props) => {
  const onClick = async (e, breed, name) => {
    ...
    if (props.cheLogin.user != null) {
      ...
      sameuser("The dog belongs to the loged-in user!!");
